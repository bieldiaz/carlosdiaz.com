...
<head>
    ...
    <title>Carlos Díaz · Mundo Reflejado</title>
</head>
...
<body>
    ...
    <div class="container gallery-container">
        <div class="row">
            <div class="col-md-12 pt-4">
                ...
                <nav class="nav navigation">
                    <ul>
                        <li><a href="/trabajoreciente" class="text-decoration-none menusuperior" style="color:black; text-decoration:none">Recientes</a></li>
                        <li><a href="/vidareflectada" class="text-decoration-none menusuperior" style="color:black;  text-decoration:none">Mundo reflejado</a></li>
                        <li><a href="/urbano" class="text-decoration-none menusuperior" style="color:black;  text-decoration:none">Mundo urbano</a></li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="row w3-container w3-center w3-animate-bottom">
            ...
            <div class="col-md-6">
                <h1 class="col-md-12 mt-5 d-block">Mundo reflejado</h1>
