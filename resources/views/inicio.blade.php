...
<body>
	...
	<div class="row">
		<div class="text-center cabezera col-md-12 mb-0">
			<h1 class="ml2 h1">Carlos Díaz · Paintings </h1>
		</div>
	</div>
		...
		<div class="col-md-12 mt-5">
			<nav class="nav navigation">
				<ul>
						...
						<ul class="menu">
							<li class="ambcontent">
								<a href="#" style="text-decoration:none;color:black;" id="subratllat">
									Works<div class="arrow-down"></div>
								</a>
								<ul class="submenu">
									<li><a href="/recentwork" id="subratllat">Recent</a></li>
									<li><a href="/reflected" id="subratllat">Reflected world</a></li>
									<li><a href="/urban" id="subratllat">Urban world</a></li>
								</ul>
							</li>
						</ul>
					</li>
					<li class="ambcontent"><a id="subratllat" href="/news" class="text-decoration-none subra" style="color:black">News</a></li>

					<li class="ambcontent"><a id="subratllat" href="/aboutme" class="text-decoration-none subra" style="color:black">About Me</a></li>
					...
					<li class="ambcontent"><a id="subratllat" href="/contact" class="text-decoration-none subra" style="color:black">Contact</a></li>
				</ul>
			</nav>
		</div>
	</div>
	...
	<script>
		...
		/* 
				function mostrar() {
					...
					document.getElementById('idioma2').style.display = 'block';
					document.getElementById('idioma3').style.display = 'block';
				}
