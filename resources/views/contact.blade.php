...
<head>
    <title>Carlos Díaz · Contact </title>
</head>
...
<div class="container" style="margin-top:-20px">
    ...
    <div class="row mt-0  ">
        ...
        <div class="col-md-5 mt-3">
            ...
            <p style="margin-top:40px; font-weight: bold; font-size:20px"><i class="fas fa-envelope"></i>&nbsp;Email: </p>
            <p style="margin-bottom:40px;">carlosdiazarte@gmail.com</p>
            <p style="border-top:1px solid black"></p>
            <!-- ====================== -->
            <p style="margin-top:40px; font-weight: bold; font-size:20px"><i class="fas fa-phone"></i>&nbsp;Phone: </p>
